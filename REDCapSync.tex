...
\begin{figure}
\includegraphics[width=0.25\linewidth,height=0.25\textheight]{figures/REDCapSync} \caption{REDCapSync: Encapsulated REDCap projects for pipelines, functions, and applications in R}\label{fig:redcapsync-logo}
\end{figure}

The REDCap API is so cool.
\CRANpkg{REDCapR}
\CRANpkg{redcapAPI}
...
Some REDCap API packages include \CRANpkg{REDCapR} and \CRANpkg{redcapAPI}\ldots{}
