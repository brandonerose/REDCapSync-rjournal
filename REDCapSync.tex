...
\item
  ...
  The central unit in REDCapSync is the encapsulated project object, which is first configured using \texttt{setup\_project()}. Project setup information cached by REDCapSync includes a user-provided project name, token name, and REDCap directory path, \emph{not} API tokens or other sensitive information. This setup makes it easy to discover what projects exist locally and to reload them without re-configuration.
...
%
%
\textit{ORCiD: \href{https://orcid.org/0009-0002-0961-9665}{0009-0002-0961-9665}}\\%
\href{mailto:nataliegoulett@gmail.com}{\nolinkurl{nataliegoulett@gmail.com}}%
}
