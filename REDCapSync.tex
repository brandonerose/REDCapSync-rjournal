...
\begin{figure}
\includegraphics[width=0.45\linewidth,height=0.25\textheight]{figures/REDCapSync} \caption{REDCapSync: Encapsulated REDCap projects for pipelines, functions, and applications in R}\label{fig:redcapsync-logo}
\end{figure}
